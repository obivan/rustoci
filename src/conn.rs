...
impl Connection {
    pub fn new(username: String,
        ...
        try!(
            rustoci_ffi::oci_attr_set(service_handle as *mut rustoci_ffi::c_void, rustoci_ffi::OCIHandleType::Service,
                                      server_handle as *mut rustoci_ffi::c_void, rustoci_ffi::OCIAttribute::Server,
                                      env.error_handle)
        );

        // Set attribute username in the session context
        try!(
            rustoci_ffi::oci_attr_set(session_handle as *mut rustoci_ffi::c_void, rustoci_ffi::OCIHandleType::Session,
        ...
        // Begin session
        try!(
            rustoci_ffi::oci_session_begin(service_handle, env.error_handle, session_handle,
        ...
        try!(
            rustoci_ffi::oci_attr_set(service_handle as *mut rustoci_ffi::c_void, rustoci_ffi::OCIHandleType::Service,
                                      session_handle as *mut rustoci_ffi::c_void, rustoci_ffi::OCIAttribute::Session,
                                      env.error_handle)
        );
...
impl Drop for Connection {
    fn drop(&mut self) {
        ...
        rustoci_ffi::oci_handle_free(self.session_handle as *mut rustoci_ffi::c_void, rustoci_ffi::OCIHandleType::Session)
            .ok().expect("oci_handle_free (session_handle) failed");
        rustoci_ffi::oci_handle_free(self.service_handle as *mut rustoci_ffi::c_void, rustoci_ffi::OCIHandleType::Service)
            .ok().expect("oci_handle_free (service_handle) failed");
        rustoci_ffi::oci_handle_free(self.server_handle as *mut rustoci_ffi::c_void, rustoci_ffi::OCIHandleType::Server)
